        ...
        <div class="flex flex-wrap items-center justify-between mx-auto">
            ...
            <div class="hidden items-center justify-between w-full md:flex md:w-auto md:order-1" id="mobile-menu-language-select">
                <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                    ...
                    <li>
                        <a href="{{url('/medicines_list')}}" class="{{ $activePage == 'medicines_list' ? 'text-primary' : 'text-black' }} block py-2 font-fira-sans pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-primary-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{{ __('Medicines') }}</a>
                    </li>
                    <li>
